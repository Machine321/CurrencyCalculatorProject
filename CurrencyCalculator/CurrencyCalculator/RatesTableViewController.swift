...
class RatesTableViewController: UITableViewController {
    ...
    var rates:CurrencyRates=CurrencyRates(baseRate: "EUR")
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return rates.myCurrences.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = rates.myCurrences[indexPath.row] + " \(rates.myRates[indexPath.row])"
